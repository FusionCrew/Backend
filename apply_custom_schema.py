...
-- Many-to-Many: MenuItem <-> Ingredient (menu_ingredient_links)
...
def main():
    try:
        ...
        cur = conn.cursor()
        print("Connected to New DB (Seoul). Applying Schema...")
        
        # Suppress notices (which might be in non-UTF8 encoding)
