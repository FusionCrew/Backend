...
public class HelloController {
    ...
    @GetMapping("/")
    public String hello() {
        return "<!DOCTYPE html>" + "<html><head><meta charset='UTF-8'><title>AI Kiosk Backend</title>"
                ...
                + "<p style='margin-top:2rem;font-size:0.9rem;opacity:0.7'>FusionCrew © 2025~2026</p></div></body></html>";
    }
